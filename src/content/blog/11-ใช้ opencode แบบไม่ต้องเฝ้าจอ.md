...
Concept คือทำยังไงให้เราจะสามารถดักจับ event เมื่อ opencode ทำงานเสร็จได้ จากนั้นรันคำสั่งส่งข้อความการแจ้งเตือน
...
เราจะเริ่มจากการเขียน plugin สำหรับแจ้งเตือน ขึ้นมาแบบง่ายๆ

### สร้าง plugin สำหรับการแจ้งเตือน

1. สร้างไฟล์ plugin ที่ path ดังต่อไปนี้ `~/.config/opencode/plugin/notify.ts`
...
> โดยการทำงาน จะทำได้เหมือนกับ web client ของ official เลยแต่ ui ใช้งานได้ง่ายขึ้นเยอะเลย~

ข้อเสียของวิธีในปัจจุบันคือ เรายังต้องรันคำสั่งอยู่ 2 คำสั่งแยกกัน ได้แก่
...
ข้อจำกัดในตอนนี้คือยังสามารถเข้าถึงการใช้งานได้เฉพาะภายใน network เดียวกันเท่านั้น

แต่ถ้าเราใช้เครื่องมืออย่าง Cloudflare Tunnel หรือ Tailscale ก็จะสามารถสั่งงานจากนอกบ้านได้สะดวกขึ้นมาก
