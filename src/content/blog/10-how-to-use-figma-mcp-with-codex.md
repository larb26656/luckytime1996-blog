...
- โค้ดที่ generate ยังมีบางส่วนที่เลือกใช้ HTML tag ไม่เหมาะสมกับหน้าที่ของ component เช่น ปุ่มถูกสร้างด้วย <div> แทน <button> ซึ่งผู้พัฒนาต้องแก้ไขเพิ่มเติมเอง
