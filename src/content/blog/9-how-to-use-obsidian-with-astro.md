...
จากนั้นให้ตั้งค่า plugin ให้บันทึกรูปภาพตาม path ที่เราต้องการ โดยไปที่ `Comunity plugins` จากนั้นคลิกรูปเฟืองเพื่อตั้งค่า plugin จะพบเมนูการตั้งค่าของ plugin
