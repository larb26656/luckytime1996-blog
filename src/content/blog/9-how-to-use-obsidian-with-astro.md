...
เนื่องด้วย IOS ออกแบบให้แต่ละแอปมี sandbox เราจึงไม่สามารถให้แอป`iSH` เข้าถึงไฟล์ของแอป`Obsidian` ได้โดยตรงจึงใช้วิธี mount โฟลเดอร์ที่อยู่บน linux เข้ากับ vault ที่เราต้องการแทนโดยใช้คำสั่ง
...
เพียงเท่านี้เราก็สามารถเข้าถึงโฟลเดอร์ vault ได้ผ่านทางแอป`iSH` แล้ว

Step ต่อไปเราจะทำการ clone โปรเจกต์เข้าโฟลเดอร์ vault

ก่อนอื่นเราจะต้องลบโฟลเดอร์ `.obsidian` ที่อยู่ในโฟลเดอร์ vault เสียก่อนด้วยคำสั่งเพื่อไม่ใช้ไฟล์มันซ้ำตอนที่เราจะ clone โปรเจกต์ โดยการรันคำสั่ง
...
เมื่อ clone โปรเจกต์สำเร็จให้เปิดแอป`Obsidian` จะพบ dialog ถามเราว่าจะ trust vault นี้ไหมเนื่องด้วยโปรเจกต์ที่ clone มามีการเปิด cummunity plugin ไว้ ให้เราคลิกปุ่ม `Trust author and enable plugins`
...
แต่เดี๋ยวก่อน... แล้วเราจะ commit และ push git ขึ้นไปยังไงหล่ะ Step ต่อมาเรามาตั้งค่า git ให้ IOS สามารถใช้งานได้ผ่านแอป`Obsidian` กัน
